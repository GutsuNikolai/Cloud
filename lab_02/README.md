...
Лабораторная работа направлена на изучение облачных вычислений с использованием платформы **Amazon Web Services (AWS)**.  
В рамках работы рассматриваются ключевые возможности AWS, включая создание и настройку виртуальных машин (**EC2**) и их использование для развертывания веб-приложений.  
Особое внимание уделяется практическому освоению базовых сервисов AWS, настройке сетевой безопасности и управлению вычислительными ресурсами через консоль и интерфейс командной строки (**AWS CLI**).
